...
function __functions {
	...
	###
	 ...
	 # E.g: newvwp example
	 #
	 #  will create https://example.test/
	 #
	 #    --spatie/ray
	 #      will allow you debug using spatie/ray
	 #
	...
	function newvwp {
		...
		if ! [[ -x $(command -v wp) ]]; then
			echo "Please install wp-cli, as it is required."
			return;
		fi
		...
		if ! [[ -x $(command -v valet) ]]; then
			echo "Please install valet, as it is required."
			return;
		fi
